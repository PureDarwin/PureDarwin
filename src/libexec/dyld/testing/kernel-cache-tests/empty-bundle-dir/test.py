...
# Make sure empty kext dirs don't crash

def check(kernel_cache):
    kernel_cache.buildKernelCollection("arm64", "/empty-bundle-dir/main.kc", "/empty-bundle-dir/main.kernel", "/empty-bundle-dir/extensions", ["com.apple.foo", "com.apple.bar"], [])
    kernel_cache.analyze("/empty-bundle-dir/main.kc", ["-layout", "-arch", "arm64"])
...
# [~]> xcrun -sdk iphoneos.internal cc -arch arm64 -Wl,-kext -mkernel -nostdlib -Wl,-add_split_seg_info bar.c -o extensions/empty.kext/PlugIns/bar.kext/bar
# [~]> rm -r extensions/foo.kext/*.ld
# [~]> rm -r extensions/empty.kext/PlugIns/bar.kext/*.ld
