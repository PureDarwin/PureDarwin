...
# Check fine grained stripping of exports

def check(kernel_cache):
    kernel_cache.buildKernelCollection("arm64", "/strip-kexts-exports/main.kc", "/strip-kexts-exports/main.kernel", "/strip-kexts-exports/extensions", ["com.apple.foo:exports", "com.apple.bar"], [])
    kernel_cache.analyze("/strip-kexts-exports/main.kc", ["-layout", "-arch", "arm64"])

    # Check the symbols
    kernel_cache.analyze("/strip-kexts-exports/main.kc", ["-symbols", "-arch", "arm64"])
