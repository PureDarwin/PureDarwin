...
# Check fine grained stripping of locals and exports

def check(kernel_cache):
    kernel_cache.buildKernelCollection("arm64", "/strip-kexts-all/main.kc", "/strip-kexts-all/main.kernel", "/strip-kexts-all/extensions", ["com.apple.foo:all", "com.apple.bar"], [])
    kernel_cache.analyze("/strip-kexts-all/main.kc", ["-layout", "-arch", "arm64"])

    # Check the symbols
    kernel_cache.analyze("/strip-kexts-all/main.kc", ["-symbols", "-arch", "arm64"])
