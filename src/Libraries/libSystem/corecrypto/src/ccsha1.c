...
void ccsha1_compress(ccdigest_state_t state, size_t nblocks, const void* in);
...
// const struct ccdigest_info ccsha1_eay_di = ccsha1_ltc_di;
...
void ccsha1_compress(ccdigest_state_t state, size_t nblocks, const void* in)
{
	...
	for (int i = 0; i < nblocks; i++)
		SHA1Transform(ccdigest_u32(state), &input[64 * i]);
}
