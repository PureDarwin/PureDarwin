...
mDNSexport mDNSu32 SetValidDNSServers(mDNS *m, DNSQuestion *question)
{
    ...
    LogInfo("SetValidDNSServers: question %##s (%s) TargetQID %d InterfaceID %p ServiceID %d -> bits 0x%08x%08x%08x%08x",
            question->qname.c, DNSTypeName(question->qtype), mDNSVal16(question->TargetQID),
            question->InterfaceID, question->ServiceID,
            question->validDNSServers.l[3], question->validDNSServers.l[2],
            question->validDNSServers.l[1], question->validDNSServers.l[0]);
