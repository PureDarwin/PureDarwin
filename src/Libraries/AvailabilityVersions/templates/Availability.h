 ...
 */
     ...
     */
// @@AVAILABILITY_MACRO_INTERFACE(__API_AVAILABLE,__API_AVAILABLE)@@

// @@AVAILABILITY_MACRO_INTERFACE(__API_AVAILABLE,__API_AVAILABLE_BEGIN,scoped_availablity=TRUE)@@
     ...
     */
// @@AVAILABILITY_MACRO_INTERFACE(__API_DEPRECATED,__API_DEPRECATED_MSG,argCount=1)@@
// @@AVAILABILITY_MACRO_INTERFACE(__API_DEPRECATED_WITH_REPLACEMENT,__API_DEPRECATED_REP,argCount=1)@@
...
// @@AVAILABILITY_MACRO_INTERFACE(__API_OBSOLETED_WITH_REPLACEMENT,__API_OBSOLETED_WITH_REPLACEMENT_BEGIN,argCount=1,scoped_availablity=TRUE)@@
     ...
     */
// @@AVAILABILITY_MACRO_INTERFACE(__API_UNAVAILABLE,__API_UNAVAILABLE)@@
  
// @@AVAILABILITY_MACRO_INTERFACE(__API_UNAVAILABLE,__API_UNAVAILABLE_BEGIN,scoped_availablity=TRUE)@@
