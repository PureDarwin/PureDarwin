...
// declarations actually use, so non-ptrauth targets compile. No-op where
// clang already defined them.
#if !__has_feature(ptrauth_intrinsics)
#  ifndef __ptrauth_objc_method_list_imp
#    define __ptrauth_objc_method_list_imp
#  endif
#  ifndef __ptrauth_objc_method_list_pointer
#    define __ptrauth_objc_method_list_pointer
#  endif
#  ifndef __ptrauth_cxx_vtable_pointer
#    define __ptrauth_cxx_vtable_pointer
#  endif
#endif
