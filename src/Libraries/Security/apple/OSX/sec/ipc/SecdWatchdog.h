...
extern NSString* const SecdWatchdogAllowedRuntime;
extern NSString* const SecdWatchdogResetPeriod;
extern NSString* const SecdWatchdogCheckPeriod;
extern NSString* const SecdWatchdogGracefulExitTime;
