/*	CoreFoundation_Prefix.h
	...
	The logs below are brief overviews of modifications made to this file:
	    ...
	    Samuel Zormeister (1/7/2026) - Add compile-time check for newer glibc on Linux.

		Samuel Zormeister (1/7/2026) - Include <CrashReporterClient.h> when available
		                               for CRSetCrashLogMessage
*/
...
#if !TARGET_OS_ANDROID && !TARGET_OS_CYGWIN && ((__GLIBC__ == 2) && __GLIBC_MINOR__ < 38)
CF_INLINE size_t
