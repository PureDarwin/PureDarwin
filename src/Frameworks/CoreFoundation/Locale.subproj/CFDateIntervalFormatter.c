/*	CFDateIntervalFormatter.c
	...
	The logs below are brief overviews of modifications made to this file:
	    ...
	    Samuel Zormeister (1/7/2026) - Include CFCalendar_Internal.h
*/
...
static void updateFormatter(CFDateIntervalFormatterRef dif) {
    ...
    if (dif->_formatter == NULL) {
         ...
         * only refines month-adjacency minimization in the formatted
         * output, a cosmetic detail, not something worth carrying a forked
         * ICU for. Dropped.
         */
