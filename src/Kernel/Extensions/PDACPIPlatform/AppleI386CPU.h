...
public:
	...
	// numCPUs sizes the controller, which sets max_cpus (hence hw.ncpu).
	bool startCommon(unsigned numCPUs);

	// A non-boot CPU: just the IOCPU the kernel gets back as cpu_id.
