 ...
 * IOHIDKeyboard.cpp (IOHIDFamily-1633.140.4, APSL), so that any driver's
 * defaultKeymapOfLength() can hand IOHIKeyboardMapper a working US layout.
 */
#ifndef _PD_HID_KEYBOARD_MAP_H
#define _PD_HID_KEYBOARD_MAP_H

    static const unsigned char gPDHIDUSAKeyMap[] = {
        0x00,0x00,
