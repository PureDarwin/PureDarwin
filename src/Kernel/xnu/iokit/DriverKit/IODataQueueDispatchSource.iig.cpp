...
#include "IODataQueueDispatchSource.h"
...
#if KERNEL
OSDefineMetaClassAndAbstractStructors(IODataQueueDispatchSource, IODispatchSource)
#endif /* KERNEL */
        ...
        IODataQueueDispatchSource ** source)
{
    ...
    ret = OSMTypeID(IODataQueueDispatchSource)->Invoke(_rpc);
