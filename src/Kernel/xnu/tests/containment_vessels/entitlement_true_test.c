...
T_DECL(contained_process_entitlement_true,
    "Ensure a process with the containment vessel entitlement is marked appropriately",
    T_META_CHECK_LEAKS(false))
{
	/* Given this binary is signed with com.apple.security.hardened-process.containment: true */
	...
	/* Then we're marked as a containment vessel */
	T_EXPECT_TRUE(conf->ipc_containment_vessel, "Expect to be marked as an IPC containment vessel");
