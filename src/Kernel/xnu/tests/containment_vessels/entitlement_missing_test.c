...
T_DECL(contained_process_unentitled,
    "Ensure a process with no containment vessel entitlement is not marked as a CV",
    T_META_CHECK_LEAKS(false))
{
	/* Given this binary does not have a com.apple.security.hardened-process.containment entitlement */
