...
#define IPC_SPACE_POLICY_ENHANCED_V2 0x0300
#define IPC_SPACE_POLICY_VERSION_MASK 0x0700
#define IPC_SPACE_POLICY_V2_EXPECTED (IPC_SPACE_POLICY_ENHANCED | IPC_SPACE_POLICY_ENHANCED_V2)
...
T_DECL(test_enhanced_v2_entitlements,
    "entitlement should enable IPC_SPACE_POLICY_ENHANCED_V2 configuration",
    T_META_CHECK_LEAKS(false))
{
	...
	T_EXPECT_EQ_UINT(vers, 2, "Platform restrictions version should be 2");
	...
	/*
	 * Check that the enhanced version is exactly V2
	 * (IPC_SPACE_POLICY_ENHANCED | IPC_SPACE_POLICY_ENHANCED_V2)
	 */
	T_MAYFAIL_WITH_RADAR(161527277);
	T_EXPECT_EQ_UINT(space_info.space_policy & IPC_SPACE_POLICY_VERSION_MASK, IPC_SPACE_POLICY_V2_EXPECTED,
	    "enhanced policy should be exactly V2");
}
