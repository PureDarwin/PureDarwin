...
#define IPC_SPACE_POLICY_ENHANCED_V3 0x0400
#define IPC_SPACE_POLICY_VERSION_MASK 0x0700
#define IPC_SPACE_POLICY_V3_EXPECTED (IPC_SPACE_POLICY_ENHANCED | IPC_SPACE_POLICY_ENHANCED_V3)
...
T_DECL(test_enhanced_v3_entitlements,
    "entitlement should enable IPC_SPACE_POLICY_ENHANCED_V3 configuration",
    T_META_CHECK_LEAKS(false))
{
	...
	T_EXPECT_EQ_UINT(vers, 3, "Platform restrictions version should be 3");
	...
	/*
	 * Check that the enhanced version is exactly V3
	 * (IPC_SPACE_POLICY_ENHANCED | IPC_SPACE_POLICY_ENHANCED_V3 = 0x0002 | 0x0400 = 0x0402)
	 */
	T_MAYFAIL_WITH_RADAR(161527277);
	T_EXPECT_EQ_UINT(space_info.space_policy & IPC_SPACE_POLICY_VERSION_MASK, IPC_SPACE_POLICY_V3_EXPECTED,
	    "enhanced policy should be exactly V3");
}
