...
/*
 * The 7195 libsyscall assembly uses LEAF without matching unwind epilogues.
 * Keep these optional annotations disabled for that source set; otherwise the
 * modern macro leaves every old syscall stub with an unfinished CFI frame.
 */
#define UNWIND_PROLOGUE
#define UNWIND_EPILOGUE
