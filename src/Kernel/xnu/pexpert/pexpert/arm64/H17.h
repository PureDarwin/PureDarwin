...
#ifndef _PEXPERT_ARM64_H17_H
#define _PEXPERT_ARM64_H17_H
...
#define HAS_MTE                  1 /* Platform has MTE support */
#define NEEDS_MTE_IRG_RESEED     1 /* Platform has an IRG that needs reseeding on context switches */
#define HAS_DISDDHWP0            1 /* Has Data-Dependent Hardware Prefetcher disablement bit. */
#define HAS_GF2                  1 /* Supports Galois Field Operations. */
#define HAS_SPECRES              1 /* Supports SPECRES. */
#define HAS_SPECRES2             1 /* Supports SPECRES2. */
