...
ifeq ($(CTFCONVERT),)
	export CTFCONVERT := /Volumes/Sources/Andromeda/PureDarwin/build/tools/dtrace_ctf/tools/ctfconvert.host
endif
ifeq ($(CTFMERGE),)
	export CTFMERGE :=  /Volumes/Sources/Andromeda/PureDarwin/build/tools/dtrace_ctf/tools/ctfmerge.host
endif
ifeq ($(CTFINSERT),)
...
ifeq ($(HOST_CODESIGN_ALLOCATE),)
	export HOST_CODESIGN_ALLOCATE	:= /Volumes/Sources/Andromeda/PureDarwin/build/tools/prefix/bin/x86_64-apple-darwin20-codesign_allocate
endif
