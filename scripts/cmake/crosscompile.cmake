set(CMAKE_DARWIN_CROSS_CREATE_STATIC_LIBRARY "${PUREDARWIN_BINARY_DIR}/tools/prefix/bin/x86_64-apple-darwin20-libtool -static -o <TARGET> <OBJECTS>")

function(add_darwin_static_library name)
    add_library(${name} STATIC)
    add_dependencies(${name} darwin_libtool)
    set_property(TARGET ${name} PROPERTY LINKER_LANGUAGE DARWIN_CROSS)
