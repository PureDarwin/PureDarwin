function(process_mig_source filename)
    ...
    foreach(def ${MIG_COMPILE_DEFINITIONS})
        list(APPEND MIG_FLAGS "-D${def}")
    endforeach()
    foreach(def ${MIG_INCLUDE_DIRECTORIES})
        list(APPEND MIG_FLAGS "-I${def}")
    endforeach()
