...
[built-in options]
c_args = ['-isysroot', '$DARWIN_SDK_ROOT', '-mmacosx-version-min=26.5', '-U_FORTIFY_SOURCE', '-D_FORTIFY_SOURCE=0', '-D_DARWIN_C_SOURCE', '-D__PUREDARWIN__=1', '-fno-stack-protector', '-I${libSystem}/usr/include', '-I${iokitHeaders}/include']
