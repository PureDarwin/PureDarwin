...
let
  ...
  deps = [ fontconfig freetype pixman ];
in
stdenv.mkDerivation {
  pname = "puredarwin-neuwld";
...
[built-in options]
c_args = ['-isysroot', '$DARWIN_SDK_ROOT', '-mmacosx-version-min=26.5', '-U_FORTIFY_SOURCE', '-D_FORTIFY_SOURCE=0', '-fno-stack-protector', '-I${libSystem}/usr/include']
