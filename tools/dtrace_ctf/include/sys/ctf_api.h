...
typedef struct ctf_sect {
	...
	int64_t cts_offset;	/* file offset of this section (if any) */
} ctf_sect_t;
...
typedef struct ctf_ptrauth {
	uint8_t ctp_key;
	uint16_t ctp_discriminator;
	bool ctp_discriminated;
} ctf_ptrauth_t;
...
extern int ctf_type_ptrauth(ctf_file_t *, ctf_id_t, ctf_ptrauth_t *);
