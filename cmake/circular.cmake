...
function(add_darwin_circular_library name)
    cmake_parse_arguments(CIRCULAR "" "INSTALL_NAME;OUTPUT_NAME" "OBJECT_LIBRARIES;SIBLINGS;STRONG_SIBLINGS;DEPENDENCIES;UPWARD;STRONG_DEPENDENCIES" ${ARGN})

    if(NOT CIRCULAR_OBJECT_LIBRARIES)
        message(FATAL_ERROR "Need to specify at least one value under OBJECT_LIBRARIES")
    endif()

    if(CIRCULAR_OUTPUT_NAME)
        set(output_name ${CIRCULAR_OUTPUT_NAME})
    else()
    ...
    set_property(TARGET ${firstpass_name} PROPERTY OUTPUT_NAME ${output_name})
