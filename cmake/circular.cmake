...
function(add_darwin_circular_library name)
    cmake_parse_arguments(CIRCULAR "" "INSTALL_NAME_DIR" "OBJECT_LIBRARIES;SIBLINGS;STRONG_SIBLINGS;DEPENDENCIES;UPWARD;STRONG_DEPENDENCIES" ${ARGN})
    ...
    add_darwin_shared_library(${firstpass_name} INSTALL_NAME_DIR ${CIRCULAR_INSTALL_NAME_DIR})
    ...
    add_darwin_shared_library(${name} INSTALL_NAME_DIR ${CIRCULAR_INSTALL_NAME_DIR})
    foreach(lib ${CIRCULAR_OBJECT_LIBRARIES})
