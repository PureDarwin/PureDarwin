function(mig filename)
    cmake_parse_arguments(MIG "NOVOUCHERS" "INCLUDES_FROM_TARGET;USER_HEADER;USER_SOURCE;SERVER_HEADER;SERVER_SOURCE;ARCH" "" ${ARGN})
    ...
    if(MIG_INCLUDES_FROM_TARGET)
        set(incs $<TARGET_PROPERTY:${MIG_INCLUDES_FROM_TARGET},INTERFACE_INCLUDE_DIRECTORIES>)
        set(defs $<TARGET_PROPERTY:${MIG_INCLUDES_FROM_TARGET},INTERFACE_COMPILE_DEFINITIONS>)
        list(APPEND MIG_FLAGS $<$<BOOL:${incs}>:-I$<JOIN:${incs},$<SEMICOLON>-I>>)
        list(APPEND MIG_FLAGS $<$<BOOL:${defs}>:-D$<JOIN:${defs},$<SEMICOLON>-D>>)

        get_property(library_type TARGET ${MIG_INCLUDES_FROM_TARGET} PROPERTY TYPE)
