function(mig filename)
    cmake_parse_arguments(MIG "NOVOUCHERS" "INCLUDES_FROM_TARGET;NODEFINES;USER_HEADER;USER_SOURCE;SERVER_HEADER;SERVER_SOURCE;ARCH" "" ${ARGN})
    ...
    add_custom_command(OUTPUT ${MIG_DEPS}
        COMMAND ${RC_HOST_BIN}/mig -arch ${MIG_ARCH}
